...
const DAILY_THEMES = [
  { name: '自然色 🌿', hueRanges: [[80, 160]], satRange: [30, 80], briRange: [30, 80] },
  { name: '日落色 🌅', hueRanges: [[0, 40]], satRange: [60, 100], briRange: [50, 90] },
  { name: '海洋色 🌊', hueRanges: [[180, 240]], satRange: [40, 90], briRange: [40, 80] },
  { name: '糖果色 🍬', hueRanges: [[300, 360], [0, 60]], satRange: [50, 90], briRange: [60, 95] },
  { name: '大地色 🏜️', hueRanges: [[20, 50]], satRange: [20, 60], briRange: [30, 70] },
  { name: '霓虹色 💡', hueRanges: [[0, 360]], satRange: [80, 100], briRange: [60, 100] },
  { name: '无限制 🎲', hueRanges: [[0, 360]], satRange: [10, 100], briRange: [10, 100] },
];
